...
function talk()
 ...
 input = string.gsub(input, " hey", "hello")
 input = string.gsub(input, " hi", "hello")
 input = string.gsub(input, " hiya", "hello")
 input = string.gsub(input, " sup", "howare")
 input = string.gsub(input, " whatsup", "howare")
 input = string.gsub(input, " how are you", "howare")
 input = string.gsub(input, " great", "positive")
 input = string.gsub(input, " amazing", "positive")
 input = string.gsub(input, " awesome", "positive")
 input = string.gsub(input, " cool", "positive")
 input = string.gsub(input, " sucky", "negative")
 input = string.gsub(input, " stupid", "negative")
 input = string.gsub(input, " idiotic", "negative")
 input = string.gsub(input, " worthless", "negative")
 input = string.gsub(input, " penis", "vulg")
 input = string.gsub(input, "stop", "cancel")
